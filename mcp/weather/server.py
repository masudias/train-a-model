...
# REST-style endpoint that wraps MCP tool: get_forecast
async def rest_get_forecast(request: Request) -> JSONResponse:
    try:
...
# REST-style endpoint that wraps MCP tool: get_alerts
async def rest_get_alerts(request: Request) -> JSONResponse:
    try:
...
def create_starlette_app(mcp_server: Server, *, debug: bool = False) -> Starlette:
    ...
    return Starlette(
        ...
        routes=[
            ...
            Route("/rest/get_forecast", endpoint=rest_get_forecast, methods=["GET"]),
            Route("/rest/get_alerts", endpoint=rest_get_alerts, methods=["GET"]),
